...
public class AddUserToProcedureTests
{
    ...
    public async Task AddUserToProcedureTests_InvalidPlanId_ReturnsBadRequest(int planId)
    {
        //Given
    ...
    [DataRow(19)]
    [DataRow(35)]
    public async Task AddUserToProcedureTests_PlanIdNotFound_ReturnsNotFound(int planId)
    {
        //Given
    ...
    [DataRow(19, 1010)]
    [DataRow(35, 69)]
    public async Task AddUserToProcedureTests_AlreadyContainsProcedure_ReturnsSuccess(int planId, int procedureId)
    {
        //Given
        var context = DbContextHelper.CreateContext();
        var sut = new AddUserToProcedureCommandHandler(context);
    ...
    [DataRow(19, 1010)]
    [DataRow(35, 69)]
    public async Task AddUserToProcedureTests_DoesntContainsProcedure_ReturnsSuccess(int planId, int procedureId)
    {
        //Given
        var context = DbContextHelper.CreateContext();
        var sut = new AddUserToProcedureCommandHandler(context);
